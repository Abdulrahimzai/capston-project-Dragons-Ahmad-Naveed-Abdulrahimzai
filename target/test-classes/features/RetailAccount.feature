...
Feature: account
 ...
 # @updateProfile
  Scenario: Verify User can update Profile Information
    And User update Name 'jamalkh' and Phon '2214209089'
  ...
  Scenario: Verify User can add a payment method
    ...
    And User fill Debit or credit card information
      ...
      | 4677562232277717 | john       |              10 |           2027 |          564 |
  ...
  Scenario: Verify User can edit Debit or Credit card
    ...
    And user edit card number '4477113006438877' name 'Abdula' security code '380'
 ...
 # @address
  Scenario: Verify User can add an Address
    ...
    And user fill new address form with below information 'Pull' and '7689604344' and '8122 Edison Ave' and '09' and 'sacramento' and '95842'
  ...
  Scenario: Verify User can edit an Address added on account
    ...
    And user fill new address form with below information fullname 'Jeff' phone '9165771843' street '2381 some street' apt '02' city 'San francisco' and '34532'
