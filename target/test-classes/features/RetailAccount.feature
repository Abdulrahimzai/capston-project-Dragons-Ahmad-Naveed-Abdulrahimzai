...
Feature: account
 ...
 # @updateProfile
  Scenario: Verify User can update Profile Information
    And User update Name 'jamilN' and Phon '2214449033'
  ...
  Scenario: Verify User can add a payment method
    ...
    And User fill Debit or credit card information
      ...
      | 4677562232233722 | john       |              10 |           2027 |          564 |
  ...
  Scenario: Verify User can edit Debit or Credit card
    ...
    And user edit card number '4477113006438877' name 'Nasim' security code '380'
 ...
 # @address
  Scenario: Verify User can add an Address
    ...
    And user fill new address form with below information 'Pull' and '7689604099' and '8122 Edison Ave' and '08' and 'sacramento' and '95842'
  ...
  Scenario: Verify User can edit an Address added on account
    ...
    And user fill new address form with below information fullname 'Mike' phone '9165771845' street '2381 some street' apt '02' city 'Sacramento' and '34532'
